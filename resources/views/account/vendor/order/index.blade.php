            ...
            <table class="table align-middle">
                ...
                <tr>
                    ...
                    <div class="table-actions d-flex align-items-center gap-3 fs-6">
                        ...
                        <a href="{{route('vendor.order.billing',$item->id)}}" class="text-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Views" aria-label="Invoice"><i class="bi bi-eye-fill"></i></a>
