...
<div class="page-breadcrumb d-none d-sm-flex align-items-center py-2 px-3" style="background: rgb(46 57 78);">
    ...
    <div class="ms-auto">
    <a href="{{route('vendor.product.index')}}" class="btn btn-primary custom-head-link"> <i class="fadeIn animated bx bx-undo"></i> Back To Product  List</a>
    </div>
</div>
<!--end breadcrumb-->
        ...
        <form action="{{route('vendor.product.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-12 text-center mt-5">
                    <a href="{{route('vendor.product.index')}}" class="btn btn-warning" style="margin-right: 20px;">Cancel</a>
