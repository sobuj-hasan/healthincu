@extends('account.layouts.app',['title' => 'Edit Category'])
...
<div class="card">
    <div class="card-body">
        <form action="{{route('admin.product-category.update',$products->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="row">
                ...
                <div class="col-12 col-md-6 py-2">
                    ...
                    <input type="text" class="form-control" name="commission" value="{{$products->commission}}">
                ...
                <div class="col-12 col-md-6 py-2">
                    <label for="" class="form-label">Category Image <img src="{{asset($products->image)}}" alt="" style="height: 100px;"></label>
