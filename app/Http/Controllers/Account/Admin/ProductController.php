...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('account.admin.product.index',$data);
    }
...

    {
        ...
        return view('account.admin.product.create',$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $input = $request->except('_token','image','_method','multi_image');
    ...
    public function show($id)
    {
        ...
        return view('account.admin.product.show',$data);
    ...
    public function edit($id)
    {
        ...
        return view('account.admin.product.edit',$data);
    }
